  ...
  <div>
    ...
    <el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="7">
          <!--???只能搜索姓名-->
          <!--？？？？bug是如果翻页之后在查询，翻过去的页面的信息不会被搜索，debug在click中增加条件queryInfo.pagenum=1，语句建用分号隔开
          此时分号后面的方法必须加（）否则无效-->
...
<!--                          {{scope.row.id}}-->
            <el-row>
              ...
              <el-tooltip effect="dark" content="删除" placement="top-start" :enterable="false">
                ...
                @click="removeUserId(scope.row.id)"></el-button>
              </el-tooltip>
              <!--                分配角色按钮-->
...
export default {
  ...
  methods: {
    ...
    // 监听添加用户对话框的关闭事件 《--------resetFields()重置方法---------》
    addDialogClosed() {
    ...
    // 此处编辑管理员信息bug，多次修改的话，会显示上一次修改的信息，
    // 删一下更新出本条要编辑的信息。解决如下
    editUserInfo() {
